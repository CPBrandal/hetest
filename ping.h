...
The task does not specify any max size, however it is reasonable to only send 256 characters as a ping message.
This can be changed in the future, for example with dynamically allocated memory.*/
struct ping_message 
{
