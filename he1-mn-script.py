...
def init_he1(self, line):
    ...
    # cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes
    # Start MIP daemons
    terms.append(openTerm(self,
                          node=A,
                          title="Host A",
                          geometry="80x20+0+0",
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./mipd -d usockA 10"))
    terms.append(openTerm(self,
                          node=B,
                          title="Host B",
                          geometry="80x20+550+0",
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./mipd -d usockB 20"))
    terms.append(openTerm(self,
                          node=C,
                          title="Host C",
                          geometry="80x20+1100+0",
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./mipd -d usockC 30"))
    ...
    terms.append(openTerm(self,
                          ...
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./ping_server usockB"))
    ...
    terms.append(openTerm(self,
                          ...
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./ping_client usockA 20 \"Hello IN3230\""))
    ...
    terms.append(openTerm(self,
                          ...
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./ping_client usockC 20 \"Hello IN4230\""))
    ...
    terms.append(openTerm(self,
                          ...
                          title="Client [A]",
                          geometry="80x20+0+300",
                          cmd="cd /home/debian/hetest-main && ./ping_client usockA 30 \"Hello IN4230\""))
    ...
    terms.append(openTerm(self,
                          ...
                          title="Client [A]",
                          geometry="80x20+0+300",
                          cmd="cd /home/debian/hetest-main && valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./ping_client usockA 20 \"Hello again IN4230\""))
